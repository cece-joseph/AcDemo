...
public class CategoriesAdapter extends RecyclerView.Adapter<CategoriesAdapter.ViewHolderBid> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolderBid holder, final int i) {
        ...
        holder.chip_categories.setText(category.getCategory());
    ...
    class ViewHolderBid extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        //    tv_category=itemView.findViewById(R.id.tv_category);\
            ...
            chip_categories=itemView.findViewById(R.id.chip_categories);
        }
